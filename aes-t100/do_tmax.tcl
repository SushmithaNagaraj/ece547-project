...
set synthesized_files [list ./src/aes_netlist.v]
set cell_lib ./src/NangateOpenCellLibrary.v
#set scan_lib ./src/osu_scan.v
set stil_file [list ./src/aes_test_protocol.spf]
#################################################
...
write_patterns ./src/${top_module}_tb_patterns.v -replace -internal -format stil -parallel 0
#################################################
#### Output reports
#################################################
